...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get welcomeTitle => 'Descubre tu Admirador Secreto';
  ...
  @override
  String get celebrityScan => 'Crush Famoso';
  ...
  @override
  String get deleteHistoryMessage => '¿Estás seguro de que deseas eliminar todo el historial de escaneos? Esta acción no se puede deshacer.';
  ...
  @override
  String get yourDailyLoveReading => 'Tu Lectura de Amor Diaria';
  ...
  @override  
  String save(String percentage) => 'Ahorra $percentage%';
  ...
  @override
  String shareMessage(String percentage, String crushName) => '¡Obtuve $percentage% de compatibilidad con $crushName en Crush Scanner! 💕 Pruébalo tú también: [App Link]';
  ...
  @override
  String helloCelebrity(String userName) => '¡Hola $userName!';
  ...
  @override
  String errorLoadingHistory(String error) => 'Error al cargar el historial: $error';
  ...
  @override
  String get purchasePremium => 'Obtener Premium - \$4.99/mes';
  ...
  @override
  String personalizedTipStreak(int streak) => '🔥 ¡Increíble racha de $streak días! Tu energía amorosa está en su punto máximo.';
  
  @override
  String personalizedTipCompatibility(int compatibility) => '⭐ Tu compatibilidad promedio es excelente ($compatibility%). ¡Tienes buen ojo para el amor!';
  
  @override
  String personalizedTipScans(int scans) => '💡 Con $scans escaneos realizados, tu experiencia amorosa está creciendo. ¡Sigue explorando!';
  ...
  @override
  String fireStreakDescription(int days) => '$days días consecutivos';
  
  @override
  String get loveExplorer => '🎯 Explorador del Amor';
  
  @override
  String loveExplorerDescription(int scans) => '$scans escaneos realizados';
  
  @override
  String get compatibilityMaster => '⭐ Maestro de la Compatibilidad';
  
  @override
  String compatibilityMasterDescription(int average) => '$average% promedio';
