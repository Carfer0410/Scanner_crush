...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override  
  String save(String percentage) => 'Save $percentage%';
  ...
  @override
  String shareMessage(String percentage, String crushName) => 'I got $percentage% compatibility with $crushName on Crush Scanner! 💕 Try it yourself: [App Link]';
  ...
  @override
  String helloCelebrity(String userName) => 'Hello $userName!';
  ...
  @override
  String errorLoadingHistory(String error) => 'Error loading history: $error';
  ...
  @override
  String personalizedTipStreak(int streak) => '🔥 Incredible $streak-day streak! Your love energy is at its peak.';
  
  @override
  String personalizedTipCompatibility(int compatibility) => '⭐ Your average compatibility is excellent ($compatibility%). You have a good eye for love!';
  
  @override
  String personalizedTipScans(int scans) => '💡 With $scans scans completed, your love experience is growing. Keep exploring!';
  ...
  @override
  String fireStreakDescription(int days) => '$days consecutive days';
  
  @override
  String get loveExplorer => '🎯 Love Explorer';
  
  @override
  String loveExplorerDescription(int scans) => '$scans scans completed';
  
  @override
  String get compatibilityMaster => '⭐ Compatibility Master';
  
  @override
  String compatibilityMasterDescription(int average) => '$average% average';
